...
cityscapes_images_dir = '/data/media/wenzhang/D10T/CityScapes/leftImg8bit'
foggy_cityscapes_images_dir = '/data/media/wenzhang/D10T/CityScapes/leftImg8bit_foggy'

DATASETS = {
    'cityscapes_train': {
        'ann_file': '/data/media/wenzhang/D10T/CityScapes/cocoAnnotations/cityscapes_train_cocostyle.json',
        'root': cityscapes_images_dir+"/train",
    },
    ...
    'cityscapes_test': {
        'ann_file': '/data/media/wenzhang/D10T/CityScapes/cocoAnnotations/cityscapes_coco_test.json',
        'root': cityscapes_images_dir+"/test",
    },

    'foggy_cityscapes_train': {
        'ann_file': '/data/media/wenzhang/D10T/CityScapes/cocoAnnotations/foggy_cityscapes_coco_train.json',
    ...
    'foggy_cityscapes_test': {
        'ann_file': '/data/media/wenzhang/D10T/CityScapes/cocoAnnotations/foggy_cityscapes_coco_test.json',
        'root': foggy_cityscapes_images_dir+"/test",
    },
    "coco_2017_train": {
    ...
    'voc_2007_trainval': {
        'root': '/data/media/wenzhang/D10T/VOCdevkit/VOCdevkit/VOC2007',
        'split': 'trainval',
    },

    'voc_2012_trainval': {
        'root': '/data/media/wenzhang/D10T/VOCdevkit/VOCdevkit/VOC2012',
        'split': 'trainval',
    },
    ...
    'watercolor_train': {
        'root': '/data/media/wenzhang/D10T/Clipart/cross-domain-detection/datasets/watercolor',
        'split': 'train',
    },
    'watercolor_test': {
        'root': '/data/media/wenzhang/D10T/Clipart/cross-domain-detection/datasets/watercolor',
