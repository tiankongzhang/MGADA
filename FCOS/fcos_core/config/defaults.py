...
_C.MODEL.TRAIN_MARK = False
_C.MODEL.ISSAMPLE = False
...
# ---------------------------------------------------------------------------- #
_C.MODEL.GENBOX = CN()
#_C.MODEL.GENBOX.USE_GENBOX = False
_C.MODEL.GENBOX.FPN_STRIDES = [8, 16, 32, 64, 128]
_C.MODEL.GENBOX.NUM = 5

# the number of convolutions used in the cls and bbox tower
_C.MODEL.GENBOX.NUM_CONVS = 4

# ---------------------------------------------------------------------------- #
# GENFEATURE Options
# ---------------------------------------------------------------------------- #
_C.MODEL.GENFEATURE = CN()
#_C.MODEL.GENFEATURE.USE_GENFEATURE = False
_C.MODEL.GENFEATURE.TWOMULTSCALE = True
_C.MODEL.GENFEATURE.LOCAL_GLOBAL_MERGE = True
_C.MODEL.GENFEATURE.POOLER_SCALES = [1.0 / 8, 1.0/16, 1.0/32, 1.0/64, 1.0/128]
_C.MODEL.GENFEATURE.POOLER_RESOLUTION = 7
_C.MODEL.GENFEATURE.CHANNELS_LEVEL = [64, 128, 256, 512, 1024]

# Focal loss parameter: alpha
_C.MODEL.GENFEATURE.POOLER_SAMPLING_RATIO = 2
_C.MODEL.GENFEATURE.FPN_STRIDES = [8, 16, 32, 64, 128]

# ---------------------------------------------------------------------------- #
# EMBEDDING Options
# ---------------------------------------------------------------------------- #
_C.MODEL.EMBEDDING = CN()
_C.MODEL.EMBEDDING.SIGMA = 0.4
_C.MODEL.EMBEDDING.RANGE_SCALE = ((-1, 64), (64, 128), (128, 256), (256, 512), (512, 3000))
...
_C.MODEL.INS.USE_DIS_P7 = False
_C.MODEL.INS.USE_DIS_P6 = False
_C.MODEL.INS.USE_DIS_P5 = False
_C.MODEL.INS.USE_DIS_P4 = False
_C.MODEL.INS.USE_DIS_P3 = False

# global and center-aware alignment
_C.MODEL.INS.USE_DIS_GLOBAL = False
_C.MODEL.INS.DT_DIS_LAMBDA = 0.01
_C.MODEL.INS.GRL_APPLIED_DOMAIN = "both"

# the number of convolutions used in the discriminator
_C.MODEL.INS.DIS_P7_NUM_CONVS = 4
_C.MODEL.INS.DIS_P6_NUM_CONVS = 4
_C.MODEL.INS.DIS_P5_NUM_CONVS = 4
_C.MODEL.INS.DIS_P4_NUM_CONVS = 4
_C.MODEL.INS.DIS_P3_NUM_CONVS = 4

# adversarial parameter: GRL weight for global discriminator
_C.MODEL.INS.GRL_WEIGHT_P7 = 0.1
_C.MODEL.INS.GRL_WEIGHT_P6 = 0.1
_C.MODEL.INS.GRL_WEIGHT_P5 = 0.1
_C.MODEL.INS.GRL_WEIGHT_P4 = 0.1
_C.MODEL.INS.GRL_WEIGHT_P3 = 0.1

_C.MODEL.CM = CN()
# discriminator of different feature layers
_C.MODEL.CM.USE_DIS_P7 = False
_C.MODEL.CM.USE_DIS_P6 = False
_C.MODEL.CM.USE_DIS_P5 = False
_C.MODEL.CM.USE_DIS_P4 = False
_C.MODEL.CM.USE_DIS_P3 = False

# global and center-aware alignment
_C.MODEL.CM.USE_CM_GLOBAL = False
_C.MODEL.CM.GL_CM_LAMBDA = 0.01
_C.MODEL.CM.GRL_APPLIED_DOMAIN = "both"

# the number of convolutions used in the discriminator
_C.MODEL.CM.DIS_P7_NUM_CONVS = 4
_C.MODEL.CM.DIS_P6_NUM_CONVS = 4
_C.MODEL.CM.DIS_P5_NUM_CONVS = 4
_C.MODEL.CM.DIS_P4_NUM_CONVS = 4
_C.MODEL.CM.DIS_P3_NUM_CONVS = 4

# adversarial parameter: GRL weight for global discriminator
_C.MODEL.CM.GRL_WEIGHT_P7 = 0.1
_C.MODEL.CM.GRL_WEIGHT_P6 = 0.1
_C.MODEL.CM.GRL_WEIGHT_P5 = 0.1
_C.MODEL.CM.GRL_WEIGHT_P4 = 0.1
_C.MODEL.CM.GRL_WEIGHT_P3 = 0.1

_C.MODEL.CM.LOSS_DIRECT_W = 0.01
_C.MODEL.CM.LOSS_GRL_W = 0.01
_C.MODEL.CM.SAMPLES_THRESH = 0.5
...
_C.SOLVER.BONE_DETECT_EPOCH = 2000
...
# GENBOX
_C.SOLVER.GENBOX = CN()
_C.SOLVER.GENBOX.BASE_LR = 0.005
_C.SOLVER.GENBOX.BIAS_LR_FACTOR = 2
_C.SOLVER.GENBOX.GAMMA = 0.1
_C.SOLVER.GENBOX.STEPS = (30000,)
_C.SOLVER.GENBOX.WARMUP_FACTOR = 1.0 / 3
_C.SOLVER.GENBOX.WARMUP_ITERS = 500
_C.SOLVER.GENBOX.WARMUP_METHOD = "linear"
# GENFEATURE
_C.SOLVER.GENFEATURE = CN()
_C.SOLVER.GENFEATURE.BASE_LR = 0.005
_C.SOLVER.GENFEATURE.BIAS_LR_FACTOR = 2
_C.SOLVER.GENFEATURE.GAMMA = 0.1
_C.SOLVER.GENFEATURE.STEPS = (30000,)
_C.SOLVER.GENFEATURE.WARMUP_FACTOR = 1.0 / 3
_C.SOLVER.GENFEATURE.WARMUP_ITERS = 500
_C.SOLVER.GENFEATURE.WARMUP_METHOD = "linear"
# FCOS
_C.SOLVER.FCOS = CN()
...
_C.TEST.LEVEL_NUMS = [86, 40, 20, 10, 8]
