...
class FCOSPostProcessor(torch.nn.Module):
    ...
    def forward_test_param(self, cfg, locations, box_cls, box_regression, centerness, image_sizes):
        """
        Arguments:
            anchors: list[list[BoxList]]
            box_cls: list[tensor]
        ...
        #print(self.pre_nms_thresh, self.pre_nms_top_n, self.fpn_post_nms_top_n)
...
def make_fcos_postprocessor(config):
    ...
    LEVEL_NUMS = config.TEST.LEVEL_NUMS
