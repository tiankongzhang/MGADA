...
class FCOSModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None, return_maps=False, box_regression_coarse=None):
        """
        Arguments:
        ...
        if self.training:
            return self._forward_train(
                ...
                box_regression, 
                centerness, targets, 
                return_maps, box_regression_coarse
            )
        else:
    ...
    def forward_op_param(self, cfg, images, features, targets=None, return_maps=False, box_regression_coarse=None):
        """
        Arguments:
            images (ImageList): images for which we want to compute the predictions
            features (list[Tensor]): features computed from the images that are
        ...
        boxes = self.box_selector_test.forward_test_param(
            cfg, locations, box_cls, 
            box_regression, centerness, images.image_sizes
        )
        return boxes, {}, None
