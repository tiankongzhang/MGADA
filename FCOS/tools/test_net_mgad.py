...
def main():
    ...
    #gen box
    model["genbox"] = build_boxgen(cfg, model["backbone"].out_channels).to(cfg.MODEL.DEVICE)
    #gen new feature
    model["genfeature"] = build_featuregen(cfg, model["backbone"].out_channels).to(cfg.MODEL.DEVICE)
